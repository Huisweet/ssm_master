...
<body>
	<div class="container">
		<h1 align="center">妖怪管理系统---姜子牙专用--修改页面</h1>
        ...
        <input type="hidden" name="monsterId" value="${m.monsterId }">
			<div class="form-group">
				<label for="shcoolName" class="col-sm-4 control-label">妖怪名称</label>
				<div class="col-sm-4">
			...
			<div class="form-group">
				<label for="entryday" class="col-sm-4 control-label">上任时间</label>
				<div class="col-sm-4">
